...
def test_int_slider():
    ...
    assert get_tick_labels(solara.IntSlider, 3, 5, 1, tick_labels=None) is None
...
def test_float_slider():
    ...
    assert get_tick_labels(solara.FloatSlider, 3, 5, 0.5, tick_labels=None) is None
    ...
    assert get_tick_labels(solara.FloatSlider, 3, 5, 0.3, tick_labels=None) is None
