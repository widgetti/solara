...
# plotly 7 removed the *_mapbox functions (deprecated since 5.24 in favour of the *_map ones),
# and plotly before 5.24 has no *_map functions: wrap whichever this plotly provides
...
if hasattr(px, "scatter_map"):
    scatter_map = _wraps(px.scatter_map)
    density_map = _wraps(px.density_map)
    line_map = _wraps(px.line_map)
    choropleth_map = _wraps(px.choropleth_map)
