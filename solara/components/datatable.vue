          ...
          <tr>
            ...
            <v-slide-x-transition :key="header.text" v-for="header in headers">
              <th class="text-no-wrap">
                  {{ header.text }}
                  <v-menu open-on-hover bottom offset-y @input="isOpen => column_header_open = isOpen ? header.value : null">
                    ...
                    <v-sheet v-if="header.value === column_header_open" class="solara-data-table-column-header-sheet">
