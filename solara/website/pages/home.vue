...
module.exports = {
    async mounted() {
        if (!document.getElementById('homepage.css')) {
            ...
            // link.href = "https://dxhl76zpt6fap.cloudfront.net/new-homepage/styles/main.css";
            link.href = "https://solara-assets.s3.us-east-2.amazonaws.com/new-homepage/styles/main.css";
            link.type = "text/css";
            link.rel = "stylesheet";
