...
def Page():
    ...
    with solara.VBox() as main:
        ...
        with solara.Card("Password"):
            solara.InputText("Enter a password", value=password, on_value=set_password, password=True)
            with solara.HBox():
        ...
        with solara.Card("Number (float)"):
            solara.InputFloat("Enter some number", value=number, on_value=set_number)
            with solara.HBox():
