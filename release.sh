...
#     exit 1;}
(git diff --quiet master @widgetti/solara-vuetify3-app@5.1.0 -- packages/solara-vuetify3-app) || {\
    ...
    exit 1;}
(git diff --quiet master @widgetti/solara-vuetify3-app@5.1.0 -- packages/solara-widget-manager) || {\
    ...
    exit 1;}
(git diff --quiet master @widgetti/solara-vuetify3-app@5.1.0 -- packages/solara-widget-manager8) || {\
