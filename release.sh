...
(git diff --quiet master @widgetti/solara-vuetify-app@10.0.2 -- packages/solara-vuetify-app) || {\
    ...
    exit 1;}
(git diff --quiet master @widgetti/solara-vuetify3-app@5.0.1 -- packages/solara-vuetify3-app) || {\
    ...
    exit 1;}
(git diff --quiet master @widgetti/solara-vuetify3-app@5.0.1 -- packages/solara-widget-manager) || {\
    ...
    exit 1;}
(git diff --quiet master @widgetti/solara-vuetify3-app@5.0.1 -- packages/solara-widget-manager8) || {\
